<template>
  ...
  >
    <section class="py-2 border-b">
      <ul>
        ...
        <li>
          ...
          >
            <svg
              class="w-6 h-6 mr-6 ml-0.5 text-gray-200"
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
            >
    ...
    <section class="px-8 py-4 font-medium leading-5 border-b">
      ...
      <button
        class="flex focus:outline-none items-center px-2 py-0.5 mt-3 text-sm text-blue-700 uppercase border border-blue-700 rounded-full"
      >
        <svg
          class="mr-2 w-7 h-7"
          fill="none"
